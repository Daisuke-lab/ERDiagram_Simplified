...
export const createSimpleTextStyles = (textRef:React.RefObject<Konva.default.Text>,
    stageRef:React.RefObject<Konva.default.Stage>,
    dispatch:AppDispatch) => {
const styles:any = {}
if (textRef.current !== null && stageRef.current !== null) {
...
const scale = textRef.current.scale();
